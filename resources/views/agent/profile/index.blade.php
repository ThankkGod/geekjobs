...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="py-3 py-lg-4">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="page-title mb-0">Agent profile</h4>
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="card rounded-3">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="my-4"><a href="{{ route('agent.profile.edit') }}" class="btn btn-primary">  Account settings <i class="mdi mdi-chevron-right"></i></a></div>
                            </div>
                        </div>
                    </div>
                </div>
