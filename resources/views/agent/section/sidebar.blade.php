  <!-- Brand Logo -->
            ...
            <div data-simplebar>
                <ul class="app-menu">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('agent.dashboard.index') }}" class="menu-link waves-effect waves-light">
                    ...
                    <li class="menu-title">Agent Profile</li>
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuExpages">
                            <ul class="sub-menu">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('agent.profile.edit') }}" class="menu-link">
                            ...
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="{{ route('posts.create') }}" class="menu-link">
                                        <span class="menu-text"> Create Job</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuLayouts">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="{{ route('applied.applicant') }}" class="menu-link">
