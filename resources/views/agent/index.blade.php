                            ...
                            <div class="col-lg-6">
                               <div class="d-none d-lg-block">
                                <ol class="breadcrumb m-0 float-end">
                                    <li class="breadcrumb-item"><a href="{{ route('agent.dashboard.index') }}">Dashtrap</a></li>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-striped table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="table-user">
                                                        <img src="{{asset('backend/assets/images/users/avatar-4.jpg')}}" alt="table-user"
                                                ...
                                                <tr>
                                                    <td class="table-user">
                                                        <img src="{{ asset('backend/assets/images/users/avatar-3.jpg') }}" alt="table-user"
                                                            class="mr-2 avatar-xs rounded-circle">
                                                        <a href="javascript:void(0);"
                                                ...
                                                <tr>
                                                    <td class="table-user">
                                                        <img src="{{asset('backend/assets/images/users/avatar-8.jpg')}}" alt="table-user"
                                                            class="mr-2 avatar-xs rounded-circle">
                                                        <a href="javascript:void(0);"
                                                ...
                                                <tr>
                                                    <td class="table-user">
                                                        <img src="{{ asset('backend/assets/images/users/avatar-1.jpg') }}" alt="table-user"
                                                            class="mr-2 avatar-xs rounded-circle">
                                                        <a href="javascript:void(0);"
                                                ...
                                                <tr>
                                                    <td class="table-user">
                                                        <img src="{{ asset('backend/assets/images/users/avatar-5.jpg') }}" alt="table-user"
                                                            class="mr-2 avatar-xs rounded-circle">
                                                        <a href="javascript:void(0);"
