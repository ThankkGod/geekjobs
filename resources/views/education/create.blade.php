                    ...
                    <div class="card border-0 rounded-2">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <span>Education</span> <span><a href="" class="btn btn-outline-success">Edit</a></span>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('educations.store') }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    <input type="text"  name="certificate_name" value="{{ old('certificate_name') }}"  placeholder="Certificate name" class="form-control" id="">
                                </div>
                                <div class="mb-3">
                                    <input type="text"  name="school_name"  value="{{ old('school_name') }}" placeholder="School name" class="form-control" id="">
                                </div>
                                <div class="mb-3">
                                    <input type="text"  name="school_location" value="{{ old('school_location') }}"  placeholder="School Location" class="form-control" id="">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Graduation year</label>
                                    <input type="date"  name="graduation_year"  value="{{ old('graduation_year') }}"  class="form-control" id="">
                                </div>
                                <div class="mb-3">
                                    <button type="submit" class="btn-theme">Create Education </button>
                                </div>
