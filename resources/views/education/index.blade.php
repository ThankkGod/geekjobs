@extends('layout.app')
@section('title', 'View all educational details')
@section('content')
                    ...
                    <div class="card border-0 rounded-2">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <span>About me</span> <span><a href="{{ route('educations.create') }}"
                                ...
                                <tbody>
                                    @forelse ($educations as $education)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('educations.edit', $education->slug) }}" class="">
                                                    <img src="{{ asset('frontend/icons/editing.png') }}" width="25"
                                                        alt="" class="img-fluid">
                                                </a>
                                                <a href="#!"
                                                    onclick="event.preventDefault(); if(confirm('Are you sure?')) document.getElementById('del-form{{ $education->slug }}').submit();">
                                                    <img src="{{ asset('frontend/icons/delete.png') }}" width="20"
                                                        alt="" class="img-fluid">

                                                </a>
                                                <form id="del-form{{ $education->slug }}"
                                                    action="{{ route('educations.destroy', $education->slug) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
