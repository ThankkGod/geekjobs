                ...
                <div class="col-lg-6">
                    <div class="d-none d-lg-block">
                        <ol class="breadcrumb m-0 float-end">
                            ...
                            <li class="breadcrumb-item active">Admin Update Agent</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card border-0 rounded-3">
                            <div class="card-body">
                                ...
                                <form action="{{ route('agents.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="text" name="name" value="{{ old('name', $user->name) }}" id="" class="form-control mb-3">
                                    <label for="" class="form-label">Agent Company  Email</label>
                                    <input type="text" name="email" value="{{ old('name', $user->email) }}" id="" class="form-control mb-3">
